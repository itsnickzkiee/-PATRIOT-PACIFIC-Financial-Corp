...
const fundedStatuses = ["Loan Funded"];
...
export default function FundedLoans() {
  ...
  useEffect(() => {
    async function loadLoans() {
      try {
        ...
        console.error(
          "Failed to fetch funded loans:",
          err,
        );

        setError(
          "Unable to load funded loans. Make sure the backend is running.",
        );
      } finally {
        setLoading(false);
      }
  ...
  if (loading) {
    return (
      <section className="active-loans-page funded-loans-page">
                      ...
                      <div className="row-actions">
                        <button
                          ...
                          onClick={(
                            ...
                            openPanel(
                              loan as Parameters<typeof openPanel>[0],
                              "details",
                            );
                          }}
                        >
